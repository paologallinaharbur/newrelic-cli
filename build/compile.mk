...
LDFLAGS    ?= "-s -w -X main.version=$(PROJECT_VER) -X main.appName=$$b -X $(PROJECT_MODULE)/internal/client.version=$(PROJECT_VER) -X $(PROJECT_MODULE)/internal/cli.Version=$(PROJECT_VER)"
SRCDIR     ?= .
